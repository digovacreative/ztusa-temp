<?php 
/**
 * Block Name: Image Background Box
 */ 
global $post;
...
<div class="gutenberg__wrap">
    ...
    ?>
    <section class="background_image_box <?php the_field('text_position'); ?> <?php the_field('content_colour'); ?>" style="background:url('<?php echo $content_image['url']; ?>');">
        
        <div class="overlay_bg <?php if(!get_field('background_image')): echo 'no_bg'; endif; ?>" style="background:<?php the_field('background_colour'); ?>;"></div>

        <article class="<?php the_field('content_size'); ?> <?php the_field('text_position'); ?> <?php the_field('padding_style'); ?> aos-item" data-aos="fade-up">
...
<script type="text/javascript">
    jQuery('iframe[src*="youtube"]').wrap('<div class="videoWrap"/>');
